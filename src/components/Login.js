            ...
            createUserWithEmailAndPassword(auth, email.current.value, password.current.value)
                .then((userCredential) => {
                    ...
                    updateProfile(user, {
                        ...
                        //photoURL: "https://staticg.sportskeeda.com/editor/2022/05/c9fe0-16537352327021-1920.jpg",
                    }).then(() => {
    ...
    return (
        <div>
            ...
            <div className='absolute '>
                <img className='h-screen w-screen' src={backgroundImage} alt='background' />
            ...
            >
                ...
                <p className='text-red-500 font-bold text-lg flex align-middle justify-center ' >{errorMessage}</p>

                <button className='p-4 my-6 bg-red-700 w-full rounded-lg font-semibold ' onClick={handleButtonClick}>{isSignInForm ? "Sign In" : "Sign Up"}</button>
